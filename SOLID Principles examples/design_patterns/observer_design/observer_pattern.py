...
class Observer(ABC):
    abstractmethod
    def update(self, subject: Circle):
        pass
...
class TextBox(Observer):
    def __init__(self) -> None:
        ...
        self.text = self.font.render(f"X: None, Y: None", True, (255, 255, 255))

    def draw(self, screen):
        screen.blit(self.text, (2, 10))

    def update(self, subject: Circle):
        x, y = subject.get_state()
        self.text = self.font.render(f"X: {x}, Y: {y}", True, (255, 255, 255))
